if (typeof window !== 'undefined' && 'serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    // Ensure manifest link is present for PWA detection
    try {
      ...
      // iOS and Android home-screen capabilities
      ...
      // Add apple splash startup images for common devices
      const splashImages = [
    ...
    navigator.serviceWorker
      ...
      .then((registration) => {
        ...
        // Ask the service worker to check for updates immediately
